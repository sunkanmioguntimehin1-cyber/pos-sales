...
async function sendWelcomeEmail(to, ownerName, storeName, tempPassword, subdomain) {
...
This email was sent by RetailCore POS.
    ...
    const messageUrl = nodemailer_1.default.getTestMessageUrl(info) || 'Preview URL not available';
